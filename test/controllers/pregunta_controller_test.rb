...
class PreguntaControllerTest < ActionController::TestCase
  ...
  test "should create preguntum" do
    assert_difference('Preguntum.count') do
      post :create, preguntum: { Pregunta_Descripcion: @preguntum.Pregunta_Descripcion, Pregunta_enunciado: @preguntum.Pregunta_enunciado, Pregunta_id: @preguntum.Pregunta_id }
    end
  ...
  test "should update preguntum" do
    patch :update, id: @preguntum, preguntum: { Pregunta_Descripcion: @preguntum.Pregunta_Descripcion, Pregunta_enunciado: @preguntum.Pregunta_enunciado, Pregunta_id: @preguntum.Pregunta_id }
    assert_redirected_to preguntum_path(assigns(:preguntum))
  end
