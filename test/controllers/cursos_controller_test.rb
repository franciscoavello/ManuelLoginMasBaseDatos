...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { Curso_año: @curso.Curso_año, Curso_id: @curso.Curso_id, Curso_nombre: @curso.Curso_nombre, Curso_semestre: @curso.Curso_semestre }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { Curso_año: @curso.Curso_año, Curso_id: @curso.Curso_id, Curso_nombre: @curso.Curso_nombre, Curso_semestre: @curso.Curso_semestre }
    assert_redirected_to curso_path(assigns(:curso))
  end
