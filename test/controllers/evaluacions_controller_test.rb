...
class EvaluacionsControllerTest < ActionController::TestCase
  ...
  test "should create evaluacion" do
    assert_difference('Evaluacion.count') do
      post :create, evaluacion: { Evaluacion_contestada: @evaluacion.Evaluacion_contestada, Evaluacion_id: @evaluacion.Evaluacion_id }
    end
  ...
  test "should update evaluacion" do
    patch :update, id: @evaluacion, evaluacion: { Evaluacion_contestada: @evaluacion.Evaluacion_contestada, Evaluacion_id: @evaluacion.Evaluacion_id }
    assert_redirected_to evaluacion_path(assigns(:evaluacion))
  end
